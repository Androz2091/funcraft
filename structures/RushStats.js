...
module.exports = class RushStats {
    ...
    constructor($, period){
        ...
        this.victoryCount = parseInt(Object.byString(stats.children[9], d)) || 0;
        this.defeatCount = parseInt(Object.byString(stats.children[11], d)) || 0;
        this.gameTime = ms(Object.byString(stats.children[13], d)) || 0;
        this.killCount = parseInt(Object.byString(stats.children[15], d)) || 0;
        this.deathCount = parseInt(Object.byString(stats.children[17], d)) || 0;
        this.destroyedBedCount = parseInt(Object.byString(stats.children[19], d)) || 0;
