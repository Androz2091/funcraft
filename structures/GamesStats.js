...
module.exports = class GamesStats {
    ...
    constructor($, period){
        ...
        this.skyWars.wl = parseInt((this.skyWars.victoryCount / this.skyWars.defeatCount || 0)*100) || 0
        this.octogone = gameStats(psi.get(3), 11, 13, 15)
        this.octogone.rank = rank(psi.get(3)) || 0
        this.octogone.damageCount = parseInt(c(path(psi.get(3).children[17], d))) || 0
        this.octogone.defeatCount = this.octogone.gameCount - this.octogone.victoryCount || 0
        this.octogone.wl = parseInt((this.octogone.victoryCount / this.octogone.defeatCount || 0)*100) || 0
        ...
        this.shootCraft.wl = parseInt((this.shootCraft.victoryCount / this.shootCraft.defeatCount || 0)*100) || 0
        ...
        this.infecte.wl = parseInt((this.infecte.victoryCount / this.infecte.defeatCount || 0)*100) || 0
        ...
        this.survival.wl = parseInt((this.survival.victoryCount / this.survival.defeatCount || 0)*100) || 0
        ...
        this.PvPSmash.wl = parseInt((this.PvPSmash.victoryCount / this.PvPSmash.defeatCount || 0)*100) || 0
